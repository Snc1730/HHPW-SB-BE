...
namespace HHPW_SB_BE.Migrations
{
    ...
    [Migration("20231016233401_UpdateOrderModel")]
            ...
            modelBuilder.Entity("HHPW_SB_BE.Models.Order", b =>
                {
                    ...
                    b.Property<string>("MenuItemQuantities")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateClosed = new DateTime(2023, 10, 17, 19, 34, 1, 405, DateTimeKind.Local).AddTicks(5849),
                            DatePlaced = new DateTime(2023, 10, 16, 19, 34, 1, 405, DateTimeKind.Local).AddTicks(5806),
                            EmployeeId = 1,
                            MenuItemQuantities = "{\"1\":2,\"2\":3}",
